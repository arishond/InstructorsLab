...
var msgTab1 = "<?php makeJavascriptStr($lang['147'], true); ?>";
var msgTab2 = "<?php makeJavascriptStr($lang['148'], true); ?>";
var msgTab3 = "<?php makeJavascriptStr($lang['149'], true); ?>";
</script>
<script src='<?php createLink('core/library/backlink.js',false,true); ?>'></script>
