  	...
  	<div class="col-md-9 top40">
        ...
        <form id="contact-form" method="post" action="#">
            <div class="">
                ...
                <button type="submit" class="btn btn-success btn-send"><i class="fa fa-mail-forward"></i> <?php trans('Continue',$lang['RF106']); ?></button>
            </div>
        </form>  
        ...
        <div class="top30 text-center alert alert-danger alert-dismissable alert-premium">
            ...
            <b><p style="color: #e74c3c;"><?php echo $lang['RF105']; ?></p></b>
            <div class="top20">
                <a class="btn btn-danger" href="<?php createLink(); ?>"><?php echo $lang['RF7']; ?></a>
            </div>
        </div>
        ...
        <div class="top30 text-center alert alert-danger alert-dismissable alert-premium">
            <i style="color: #e74c3c; font-size: 120px;" class="fa fa-ban" aria-hidden="true"></i>
            <p style="color: #e74c3c;"><?php echo ucfirst($domainName). ' - ' . $lang['RF152']; ?> <br />
