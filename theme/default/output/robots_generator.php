...
<option value=" /"><?php echo $lang['152']; ?></option>
    ...
    <p>
	<input type="button" class="btn btn-success" onclick="genRobots(this.form,msg1)" value="<?php echo $lang['161']; ?>" /> 
	<input type="button" class="btn btn-danger" onclick="genRobots(this.form,msg1,true)" value="Create and Save as Robots.txt" /> 
