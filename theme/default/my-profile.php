  	...
  	<div class="col-md-8 top40 profile">
        ...
        <div class="tab-content">
          ...
          <div id="password" class="tab-pane fade">
            ...
            <?php if(isset($_SESSION[N_APP.'AdminToken'])){ ?>
                <div class="form-group">
                    <?php trans('Current Password',$lang['RF134']); ?> <b>(Administrator not required to enter current password!)</b> <br />
                    <input disabled value="0000000" placeholder="<?php trans('Enter your current password',$lang['RF140']); ?>" type="password" name="old_pass" class="form-control"  style="width: 96%;"/>
                </div>
            <?php  } else { ?>
            <div class="form-group">
