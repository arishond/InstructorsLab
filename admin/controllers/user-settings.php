...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "UPDATE user_settings SET visitors_limit='$visitors_limit', enable_reg='$enable_reg', enable_oauth='$enable_oauth', enable_quick='$enable_quick', oauth_keys='$oauth_keys' WHERE id='1'";
...
$visitors_limit = intval($row['visitors_limit']);
